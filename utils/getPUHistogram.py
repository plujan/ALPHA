...
mc = TH1F("2016_25ns_Moriond17MC_PoissonOOTPU", "True nPV distribution", 100, 0, 100)
mc.Sumw2()
...
#    outFile = TFile("../data/PU_MC.root", "RECREATE")
    outFile = TFile("../data/PU_MC_Moriond17.root", "RECREATE")
    outFile.cd()
    mc.Write()
    outFile.Close()
#    print "Histograms written to ../data/PU_MC.root file"
    print "Histograms written to ../data/PU_MC_Moriond17.root file"
    exit()
   
#puFile = TFile("../data/PU_69200.root", "READ")
puFile = TFile("../data/PU_69200_ReReco.root", "READ")
...
puUpFile = TFile("../data/PU_72380_ReReco.root", "READ")
...
puDownFile = TFile("../data/PU_66020_ReReco.root", "READ")
...
leg.AddEntry(mc, "MC 25ns Moriond17", "pl")
...
mc.Draw("SAME, L")
leg.Draw()
c1.Print("PU/PU_%s.pdf"%"Moriond17")
c1.Print("PU/PU_%s.png"%"Moriond17")
