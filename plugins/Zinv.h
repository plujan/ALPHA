...
class Zinv : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
    public:
        explicit Zinv(const edm::ParameterSet&);
        ~Zinv();
    ...
    private:
        ...
        TH2F* MetDPhiNoMuPreTrig_MuSel;
        TH2F* MetDPhiWithMuPreTrig_MuSel;
        TH2F* MetDPhiNoMuPostTrig_MuSel;
        TH2F* MetDPhiWithMuPostTrig_MuSel;
        //TH2F* MetDPhiPreTrig_MuSel;
        //TH2F* MetDPhiPostTrig_MuSel;
        TH2F* MetDPhiPreTrig_EleSel;
        TH2F* MetDPhiPostTrig_EleSel;
