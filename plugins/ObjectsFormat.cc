...
void ObjectsFormat::FillFatJetType(FatJetType& I, const pat::Jet* R, bool isMC) {
  ...
  //  }
    ...
    I.softdropPuppiMassGenCorr = R->hasUserFloat("ak8PFJetsPuppiSoftDropMassGenCorr") ? R->userFloat("ak8PFJetsPuppiSoftDropMassGenCorr") : -1.;
