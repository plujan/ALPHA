  ...
  useAbsEta(true)
{
  ...
  if (tagger_name.find("CSVv2") != std::string::npos || tagger_name.find("csvv2") != std::string::npos){
    if (params.operatingPoint == BTagEntry::OP_LOOSE){_op_cutvalue = 0.460;}
    else if (params.operatingPoint == BTagEntry::OP_MEDIUM){_op_cutvalue = 0.800;}
    else if (params.operatingPoint == BTagEntry::OP_TIGHT){_op_cutvalue = 0.935;}
    else if (params.operatingPoint == BTagEntry::OP_RESHAPING){_op_cutvalue = -999;}
  }
  else if (tagger_name.find("JP") != std::string::npos || tagger_name.find("jp") != std::string::npos){
    if (params.operatingPoint == BTagEntry::OP_LOOSE){_op_cutvalue = 0.245;}
    else if (params.operatingPoint == BTagEntry::OP_MEDIUM){_op_cutvalue = 0.515;}
    else if (params.operatingPoint == BTagEntry::OP_TIGHT){_op_cutvalue = 0.760;}
    else if (params.operatingPoint == BTagEntry::OP_RESHAPING){_op_cutvalue = -999;} //default value, of no importance
  }
    ...
    if (params.operatingPoint == BTagEntry::OP_LOOSE){_op_cutvalue = -0.715;}
    else if (params.operatingPoint == BTagEntry::OP_MEDIUM){_op_cutvalue = 0.185;}
    else if (params.operatingPoint == BTagEntry::OP_TIGHT){_op_cutvalue = 0.875;}
    else if (params.operatingPoint == BTagEntry::OP_RESHAPING){_op_cutvalue = -999;}
  }
  else{
