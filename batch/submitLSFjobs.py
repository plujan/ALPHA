...
parser.add_option('-c', '--cfg',          action='store', type='string', dest='cfg',          default='python/HHAnalyzer.py')
parser.add_option('-l', '--filelists'   , action='store', type='string', dest='filelists',    default='HHbase')
