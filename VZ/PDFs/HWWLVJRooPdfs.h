...
class RooExpTail2Pdf : public RooAbsPdf {
public:
  RooExpTail2Pdf() {} ; 
  RooExpTail2Pdf(const char *name, const char *title,
          RooAbsReal& _x,
          RooAbsReal& _s,
          RooAbsReal& _a,
          RooAbsReal& _w);

  RooExpTail2Pdf(const RooExpTail2Pdf& other, const char* name=0) ;

  virtual TObject* clone(const char* newname) const { return new RooExpTail2Pdf(*this,newname); }

  inline virtual ~RooExpTail2Pdf() { }
...
private:
  ...
  ClassDef(RooExpTail2Pdf,1) // Your description goes here...
};

////// Alpha function given by the ratio of two levelled exp
class RooAlpha4ExpTail2Pdf : public RooAbsPdf {
public:
  RooAlpha4ExpTail2Pdf() {} ; 
  RooAlpha4ExpTail2Pdf(const char *name, const char *title,
          RooAbsReal& _x,
          RooAbsReal& _s0,
          RooAbsReal& _a0,
          RooAbsReal& _w0,
  ...
  RooAlpha4ExpTail2Pdf(const RooAlpha4ExpTail2Pdf& other, const char* name=0) ;

  virtual TObject* clone(const char* newname) const { return new RooAlpha4ExpTail2Pdf(*this,newname); }

  inline virtual ~RooAlpha4ExpTail2Pdf() { }
...
private:
  ...
  ClassDef(RooAlpha4ExpTail2Pdf,1) // Your description goes here...
};


//////// ErfExpTail Pdf = Levelled exp with 2 parameter
Double_t ExpN2(Double_t x, Double_t s, Double_t a, Double_t w);

class RooExpN2Pdf : public RooAbsPdf {
public:
  RooExpN2Pdf() {} ; 
  RooExpN2Pdf(const char *name, const char *title,
        RooAbsReal& _x,
        RooAbsReal& _s,
        RooAbsReal& _a,
        RooAbsReal& _w );

  RooExpN2Pdf(const RooExpN2Pdf& other, const char* name=0) ;

  virtual TObject* clone(const char* newname) const { return new RooExpN2Pdf(*this,newname); }

  inline virtual ~RooExpN2Pdf() { }
...
private:
  ...
  ClassDef(RooExpN2Pdf,1) // Your description goes here...
};


////// Alpha function given by the ratio of two levelled exp
class RooAlpha4ExpN2Pdf : public RooAbsPdf {
public:
  RooAlpha4ExpN2Pdf() {} ; 
  RooAlpha4ExpN2Pdf(const char *name, const char *title,
          RooAbsReal& _x,
        RooAbsReal& _s0,
        RooAbsReal& _a0,
        RooAbsReal& _w0,
  ...
  RooAlpha4ExpN2Pdf(const RooAlpha4ExpN2Pdf& other, const char* name=0) ;

  virtual TObject* clone(const char* newname) const { return new RooAlpha4ExpN2Pdf(*this,newname); }

  inline virtual ~RooAlpha4ExpN2Pdf() { }
...
private:
  ...
  ClassDef(RooAlpha4ExpN2Pdf,1) // Your description goes here...
};
